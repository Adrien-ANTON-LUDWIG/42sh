...
#define TOKENS_TO_STRING                                                       \
    {                                                                          \
        "WORD_IF", "WORD_THEN", "WORD_ELIF", "WORD_ELSE", "WORD_FI",           \
            ...
            "WORD_DONE", "WORD_FUNCTION", "WORD_CASE", "WORD_ESAC",            \
            "WORD_LBRACKET", "WORD_RBRACKET", "WORD_AND", "WORD_OR",           \
            "WORD_PIPE", "WORD_REDIR_LR", "WORD_REDIR_RP", "WORD_REDIR_LA",    \
            "WORD_REDIR_RA", "WORD_REDIR_LLM", "WORD_REDIR_LL",                \
            "WORD_REDIR_RR", "WORD_REDIR_L", "WORD_REDIR_R", "WORD_COMMAND",   \
            "WORD_EOF", "WORD_SUPERAND", "WORD_SEMIC", "WORD_NEWLINE",         \
